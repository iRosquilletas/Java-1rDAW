...
public class Cafeteria1 {
        public static void main(String[] args) {
                ...
                System.out.println(
                                " servir -> Cantidad actual de café en la cafetera: " + miCafetera.getCantidadActual()
                                                + " ml");

                miCafetera.agregarCafe(500);
                System.out.println(
                                " agregar -> Cantidad actual de café en la cafetera: " + miCafetera.getCantidadActual()
                                                + " ml");

                miCafetera.vaciarCafetera();
                System.out
                                .println("vaciar -> Cantidad actual de café en la cafetera: "
                                                + miCafetera.getCantidadActual() + " ml");
