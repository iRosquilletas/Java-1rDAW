...
public abstract class Objeto {
    ...
    private Posicion pos; // Posición de su esquina superior izquierda según la pantalla (0,0 sería la
                          // esquina superior izquierda de la pantalla)
    private int dirx; // Dirección en X (1 se desplaza a derecha, -1 se desplaza a izquierda, 0 no se
                      // mueve en horizontal)
    private int diry; // Dirección en Y (1 se desplaza hacia abajo, -1 se desplaza hacia arriba, 0 no
